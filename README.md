...
# Sorting
By default, the Sort button (that is located next to the Add button) will sort your list by priority, ascending. Using the Sort BY option, you can choose to sort your Todo list by date or by category. After you choose the sort option, just press the Sort button.
